  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="max-w-4xl mx-auto px-6 py-16 md:py-24">
        ...
        <Section delay={0.1}>
          <p>
            SMYD Global provides IT services and digital products. This Shipping
            Policy outlines how digital and physical deliveries are handled.
          </p>
        </Section>

        <Section title="Digital Product Delivery" delay={0.15}>
          <InfoBox title="Instant Delivery" delay={0.2}>
            <p>
              Software licenses, digital assets, or project files are delivered
              immediately to your registered email after payment confirmation.
            </p>
          </InfoBox>

          <InfoBox title="Cloud-Based Services" delay={0.25}>
            <p>
              Access credentials for cloud or SaaS platforms will be shared via
              email within 24–48 hours after activation.
            </p>
          </InfoBox>
        </Section>

        <Section title="Physical Delivery (If Applicable)" delay={0.3}>
          <InfoBox title="Shipping Partners" delay={0.35}>
            <p>
              Physical items are delivered through trusted logistics companies
              depending on availability and region.
            </p>
          </InfoBox>

          <InfoBox title="Delivery Time" delay={0.4}>
        ...
        <Section title="Tracking Information" delay={0.45}>
          <p>
            After dispatch, a tracking ID and courier details will be shared via
            email or SMS.
          </p>
        </Section>

        <Section title="Shipping Support" delay={0.5}>
          <p>
            For delivery issues or delays, contact us at{" "}
